...
public static class ActionDescriptions
{
    ...
    public const string VIGNETTE = "Adds a radial dim to the outer edges of the image.  The stronger the effect, the more darkening will occur.  At strength 200, the image will have a \"spotlight\" in the center and the edges will be entirely black.";
    public const string WHITE_VIGNETTE = "Adds a radial dodge to the outer edges of the image.  The stronger the effect, the more brightening will occur.  At strength 200, the image will have a \"spotlight\" in the center and the edges will be entirely white.";
    ...
    public const string TITLE_VIGNETTE = "Vignette";
    public const string TITLE_WHITE_VIGNETTE = "White Vignette";
