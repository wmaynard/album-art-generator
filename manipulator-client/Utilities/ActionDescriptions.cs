...
public static class ActionDescriptions
{
    ...
    public const string DODGE = "Adds a radial dodge to the outer edges of the image.  The stronger the effect, the more brightening will occur.  At strength 200, the image will have a \"spotlight\" in the center and the edges will be entirely white.";
    ...
    public static readonly string HELP_DODGE = $"{TITLE_DODGE}{Environment.NewLine}{Environment.NewLine}{DODGE}{Environment.NewLine}The effect strength is proportional to image size, not directly tied to the image resolution.";
    ...
    public const string TITLE_DODGE = "Dodge Edges";
